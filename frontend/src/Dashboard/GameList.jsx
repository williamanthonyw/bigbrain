...
import { Button, Card, CardBody, CardTitle, CardText, Placeholder } from "react-bootstrap";

function GameList({ games, hoveredIndex, setHoveredIndex, setSelectedGame, openNewGameModal }) {
  return (
